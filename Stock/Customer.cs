    ...
    public partial class Customer : Form
    {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    connection.Open();
                    query = "insert into customer values(@id,@name,@address,@email,@number)";
        ...
        private void buttonEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                connection.Open();
                query = "update customer set name=@name,address=@address,email=@email,number=@number where id=@id)";
                command = new MySqlCommand(query, connection);
